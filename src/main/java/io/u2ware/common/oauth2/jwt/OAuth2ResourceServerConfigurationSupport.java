...
public class OAuth2ResourceServerConfigurationSupport {
    ...
    public OAuth2ResourceServerConfigurationSupport(SecurityProperties securityProperties, OAuth2ResourceServerProperties oauth2Properties){
    ...
    public JwtEncoder encoder(JwtEncoder encoder) throws Exception{
        this.jwtEncoder = encoder;
        return jwtEncoder;
    }

   
    public JwtDecoder decoder(JwtDecoder decoders) throws Exception{

        List<JwtDecoder> collection = new ArrayList<>(Arrays.asList(decoders))  ;
